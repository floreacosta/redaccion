...
(4, 'comprar.php', 'comprar'),
(5, 'edicion.php', 'edicion'),
(6, 'modificacion_contenido.php', 'modificacion contenido'),
(7, 'nota.php', 'nota'),
(8, 'perfil_modificacion.php', 'perfil modificacion'),
(9, 'registro-lector.php', 'registro lector'),
(10, 'resultado_busqueda.php', 'resultado busqueda'),
(11, 'usuario_registrado.php', 'usuario registrado'),
(12, 'error.php', 'error'),
